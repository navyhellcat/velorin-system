...
| Archival backups | `/Users/lbhunt/Desktop/Velorin/Velorin Code/Archival/` |
| Hooks scripts | `/Users/lbhunt/Desktop/Velorin/Velorin Code/hooks/` |
...
## Pointers
- [1] `./trailing-space.md` — paths with "Velorin " must be quoted
- [2] `./github-repos.md` — which paths map to which repos
