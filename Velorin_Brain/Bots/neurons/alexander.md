...
Claude Desktop app bot. GUI-based.
Manages MCP servers (they start/stop with the app).
Accesses filesystem via bash MCP and claude-code MCP.
Accesses GitHub via github MCP.
